...
Algorithm based on the manhattan distance: find the closest connection from a house to a powersource and try to connect.
"""
...
from code.classes.stepthreeandfour.random import functions
        ...
        while run < number_iterations:
            ...
            while len(houses.houses_unconnected) > 0 and count < 10000:
                ...
                try:
                    ...
                    current_house = functions.random_house(houses_list)
                    current_powersource = functions.random_powersource(self.powerlist)
