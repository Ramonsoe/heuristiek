...
class Closest_first():
    ...
    def __init__(self, houses, powersources, batteries, min_capacity):

        self.powerlist = functions.add_powersource(powersources)
        self.initial_powerlist = copy.deepcopy(self.powerlist)
        self.closest_first = self.run(houses, self.powerlist, batteries, min_capacity)

    def run(self, houses, powersources, batteries, min_capacity):
